...
Cross-implementation throughput figures are quoted from external benchmarks
(secnetperf, KIT 2025, TQUIC, quic-go#3670) — **not measured by quicz**. The
full source-attributed table lives on the [feature comparison](/comparisons/) page.
